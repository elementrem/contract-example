...
- The CPU size must be a single core operating at least independently.			
- If you run mining and meteor wallet at the same time, The CPU must be dual-core or higher.		
...
**3. Repeat steps 1-2 to create a second or more on you network**
...
![](img/elementrem-meteor.png)

You can run Elementrem meteor-wallet. 
...
**6. Increase security through Network security group**		
...
`Network security group` enhancements and other features will help you protect your sensitive wallet data.		

e.g.:			
![](img/network-security-group-eg.png)		
